...
export class Broadcast {
	...
	async #run() {
		...
		const ns = await this.connection.publish_namespace(this.namespace)
		console.log("[Broadcast] waiting for PUBLISH_NAMESPACE_OK...")
		await ns.ok()
		console.log("[Broadcast] namespace acknowledged by relay, waiting for subscribers...")
